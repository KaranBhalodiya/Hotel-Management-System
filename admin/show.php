...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>Novotel HOTEL,</p>
				<p>New Kalmunani Road,<br>Rajasthan,<br>India.</p>
				<p>(+91) 65 222 44 55</p>
			</address>
			<span><img alt="" src="assets/img/novotel.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table >
					...
					<tr> 
						<td>Hotel City : -  <?php echo $city; ?> </td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@novotel.com || Web :- www.novotel.com || Phone :- +91 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
